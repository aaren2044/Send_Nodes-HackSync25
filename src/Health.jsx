  ...
  return (
    <div className="health-container">
      ...
      <div className="health-sections">
        ...
        <div className="health-section">
          <h2><Link to="/heart-rate">Heart Rate</Link></h2>
          <p>72 bpm</p>
        </div>
        <div className="health-section">
          <h2><Link to="/physical-effort">Physical Effort</Link></h2>
          <p>Moderate</p>
        </div>
        <div className="health-section">
          <h2><Link to="/workout-summary">Workout Summary</Link></h2>
          <ul>
        ...
        <div className="health-section">
          <h2><Link to="/health-summary">Health Summary</Link></h2>
          <ul>
        ...
        <div className="health-section">
          <h2><Link to="/sleep">Sleep Analysis</Link></h2>
